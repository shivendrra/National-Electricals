...
export default function Products() {
  ...
  const DownloadBrochure = () => {
    ...
    window.location.href = 'https://drive.google.com/file/d/1wJ7JWyU5c0r6_zRdDKIWHDXkSgO3CNJT/view?usp=drive_link';
  }
    ...
    <>
      <div className="products row" style={{ padding: '120px 20px' }}>
        <div className="col-lg-12 py-3">
          <h4 className='text-center quote'><b>"</b><em>Our dedication to crafting these industrial essentials is more than just a business; it's a passion. We are committed to empowering your operations, ensuring they run smoothly, efficiently, and profitably. With our machinery at your side, you're not just investing in equipment; you're investing in the future of your business.</em><b>"</b></h4>
        </div>
